...
def validate_all():
    ...
    print("\n─── Phase 5: Ghost Reference Detection ───")
    ghost_terms = ["Generic Manager", "boundary_sync.py", "audit_script.py", "review_text", "sentiment_score", "sklearn_logreg", "Lifespan Handled", "movie", "imdb", "aclImdb", "medtext", "MedText", "Sentiment Scope", "train.py", "train_transformer.py", "SGDClassifier", "DistilBERT", "model_choice"]
